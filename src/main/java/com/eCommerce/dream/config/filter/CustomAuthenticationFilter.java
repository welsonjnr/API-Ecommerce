package com.eCommerce.dream.config.filter;
...
public class CustomAuthenticationFilter extends UsernamePasswordAuthenticationFilter {
    ...
    public CustomAuthenticationFilter (AuthenticationManager authenticationManager, PropertiesConfiguration propertiesConfiguration){
    ...
    protected void successfulAuthentication(HttpServletRequest request, HttpServletResponse response, FilterChain chain, Authentication authentication) throws IOException, ServletException {
        ...
        String refresh_token = JWT.create()
                .withSubject(user.getUsername())
                .withExpiresAt(new Date(System.currentTimeMillis() + 24 * 365 * 60 * 60 * 1000))
